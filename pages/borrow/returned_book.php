          ...
          <div class="col-md-12">
            ...
            <div class="card card-body">
              <div class="card-header">
               <h3 class="col-xs-6"><span class="fa fa-book"></span> RETURNED BOOKS MONITORING FOR <b><?php echo strtoupper($_SESSION['campus'])?> CAMPUS</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
--><hr>
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li class="col-xs-2">
                            <a href="print_returned_book.php?campus=<?php echo $_SESSION['campus']?>" target="_blank" style="background:none;">
                        ...
                        <hr>
        <!--- sort -->
                        <form method="POST" action="returned_book_search.php?campus=<?php echo $_SESSION['campus']?>" class="form-inline">
                    ...
                    <div class="x_content">
                        <div class="box">
                            ...
                            if ($_SESSION['campus'] == "All") {
                                ...
                                LEFT JOIN book ON return_book.book_id = book.book_id
                                LEFT JOIN campus ON campus.campus_id = book.campus_id")or die(mysql_error());
                            ...
                            LEFT JOIN user ON return_book.user_id = user.user_id
                            LEFT JOIN campus ON campus.campus_id = book.campus_id
                            where campus = '$_SESSION[campus]' AND return_book.return_book_id order by return_book.return_book_id DESC") or die (mysql_error());
                                $return_count = mysqli_num_rows($return_query);
                                
                            $count_penalty = mysqli_query($con,"SELECT sum(book_penalty) FROM return_book
                            LEFT JOIN book ON return_book.book_id = book.book_id
                            LEFT JOIN campus ON campus.campus_id = book.campus_id
                            WHERE campus = '$_SESSION[campus]'")or die(mysql_error());
                            $count_penalty_row = mysqli_fetch_array($count_penalty);
                            }
                            ?>
...
?>
                            <tr>
                                ...
                                <td style="text-transform: capitalize"><?php echo $return_row['campus']; ?></td>
