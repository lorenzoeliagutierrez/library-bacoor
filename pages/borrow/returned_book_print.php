...
<body>
	<div class = "container">
		...
		<br/>
			...
			<p style = "margin-left:10px; margin-top:20px; font-size:14pt; font-weight:bold;">Returned Books Monitoring FOR <b><?php echo strtoupper($_SESSION['campus'])?> CAMPUS</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
if ($_SESSION['campus'] == "All") {
							...
							where campus = '$_SESSION[campus]' AND return_book.date_returned BETWEEN '".$_SESSION['datefrom']." 00:00:01' and '".$_SESSION['dateto']." 23:59:59' 
							order by return_book.return_book_id DESC") or die (mysql_error());
							$return_count = mysqli_num_rows($return_query);
							...
							LEFT JOIN book ON return_book.book_id = book.book_id
							LEFT JOIN campus ON campus.campus_id = book.campus_id
							where campus = '$_SESSION[campus]' AND return_book.date_returned BETWEEN '".$_SESSION['datefrom']." 00:00:01' and '".$_SESSION['dateto']." 23:59:59'  ")or die(mysql_error());
							$count_penalty_row = mysqli_fetch_array($count_penalty);
}
